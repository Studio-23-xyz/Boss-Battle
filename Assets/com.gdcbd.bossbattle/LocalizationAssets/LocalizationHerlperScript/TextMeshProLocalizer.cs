...
public class TextMeshProLocalizer : MonoBehaviour
{
    ...
    public async UniTask SetTextAndWait(LocalizedString localizedString, string tempText= "")
    {
        ...
        AsyncOperationHandle<string> setTextHandle = _localizer.StringReference.GetLocalizedStringAsync();
        await setTextHandle;
        _tmpTarget.text = setTextHandle.Result;
    }
    ...
    {
        SetText(localizedString, tempText);
        AsyncOperationHandle<string> handle = _localizer.StringReference.GetLocalizedStringAsync();
        await handle;
